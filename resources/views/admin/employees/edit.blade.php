                ...
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    ...
                    @include('message_data')
                        <form class="needs-validation" novalidate id="edit_form" name="edit_form" action="{{ route('update_employees', $userdata->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf            
                        <div class="form-row">
                          <div class="col-md-6 mb-3">
                            <label for="comp_name">Name <span class="astrick">*</span></label>
                                <input type="text" class="form-control" id="comp_name" placeholder="Name" name="name" value="{{!empty(old('name'))?old('name'):$userdata->name}}">
                        ...
                        <div class="col-md-6 mb-3">
                          <label for="phone">DOB</label>
                              <input id="dob" type="text" class="form-control onlynum" name="dob" placeholder="DOB" value="{{!empty(old('DOB'))?old('DOB'):$userdata->DOB}}">
