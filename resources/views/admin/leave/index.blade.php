            ...
            <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <h2 class="h4 mb-1">Leave Management</h2>
                      ...
                      <div class="toolbar row mb-3">
                        <div class="col">
                          <form class="form-inline" action="" method="GET" role="search">
                            ...
                            <a href="{{ url('/admin/leave_management') }}" class="btn btn-secondary">Reset</a>
                          </form>
                        </div>
                ...
                foreach ($data as $key => $value) { ?>
                    <tr>
                        ...
                        <td class="mb-0 text-center">
                          <a class="mr-3" href="{{url('admin/edit_leave/'.$value->id)}}" alert="Edit"><i class="fe fe-edit fe-16"></i></a>
